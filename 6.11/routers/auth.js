...
import { sendEmail } from "../utils/nodemailerSender.js";
...
router.post('/registration', async (req, res, next) => {
    try{
        ...
        const registrationEmail = {
            ...
            html: `<div>
                <h1 style="color: #00B7FF; background: antiquewhite">Hello ${user.name},</h1>
                <p style="color: blueviolet">Happy to see you here</p>
            </div>`
        }
